...
using AccionaSeguridad.Droid.UI.Controls;
...
namespace AccionaSeguridad.Droid.UI.Features.WorkingCenter
{
    public class WorkingCenterFragment : BaseFragment<WorkingCenterPresenter>, WorkingCenterUI
    {
        ...
        private View otherTitle;
        private TextView textOther;

        internal static WorkingCenterFragment NewInstance()
        {
        ...
        protected override void AssingViews(View view)
        {
            ...
            textOther = view.FindViewById<TextView>(Resource.Id.other);
            otherTitle = view.FindViewById(Resource.Id.otherTitle);
            ...
            listPais.ItemChanged += (o, pais) =>
            {
                ...
                otherTitle.Visibility = ViewStates.Visible;
                textOther.Visibility = ViewStates.Visible;
                textOther.Text = "";
            };
            ...
            listCentro.ItemChanged += (o, loc ) =>
            {
                ...
                {
                    otherTitle.Visibility = ViewStates.Gone;
                    textOther.Visibility = ViewStates.Gone;
                }
        ...
        public void SetLocations(IEnumerable<Location> locations)
        {
            ...
            {                                
                ...
                if (selected.IdLocation == -1)
                {
                    otherTitle.Visibility = ViewStates.Visible;
                    textOther.Visibility = ViewStates.Visible;
                    textOther.Text = selected.Extra;
                }
            }
        }
    }
