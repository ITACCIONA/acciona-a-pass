...
using AccionaSeguridad.Droid;
using AccionaSeguridad.Droid.Utils;

namespace AccionaSeguridad.Droid.UI.Controls
{
    [Register("views.ListStringEditText")]
    public class ListStringEditText : AppCompatEditText, View.IOnTouchListener
    {
        ...
        public ListStringEditText(Context context) : base(context)
        {
            init();
        }

        public ListStringEditText(Context context, IAttributeSet attrs) : base(context, attrs)
        {

            init();
        }

        public ListStringEditText(Context context, IAttributeSet attrs, int defStyle) : base(context, attrs, defStyle)
        {
            init();
        }
        ...
        public class ListEditTextDialogFragment : Android.Support.V4.App.DialogFragment
        {
            ...
            private IEnumerable<string> objects;
            ...
            private void TextWatcher_TextChanging(object sender, string filterSearch)
            {
                Task.Run(() =>
                {
                    ...
                    {
                        var filtered = objects.Where(x => x.IgnoreContains(filterSearch));
            ...
            public async Task SetObjects(IEnumerable<string> objects)
            {
            ...
            public class ListEditTextAdapter : RecyclerView.Adapter
            {
                ...
                public ListEditTextAdapter(Context context, IEnumerable<string> elements)
                {
                ...
                public override void OnBindViewHolder(RecyclerView.ViewHolder holder, int position)
                {
                    ...
                    vh.Text.Text = elements[position];
                }
                ...
                internal void SetObjects(IEnumerable<string> newObjects)
                {
