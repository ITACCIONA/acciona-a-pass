...
namespace Acciona.iOS.UI.Controls
{
    ...
    public partial class ListStringPickerViewController : UIViewController
    {
        ...
        public ListStringPickerViewController(List<string> tableData) : base("ListStringPickerViewController", null)
        {
        ...
        private void SearchTextField_ValueChanged(object sender, EventArgs e)
        {
            ...
            {
                var filtered = tableData.Where(x => x.IgnoreContains(filterSearch));
        ...
        void SelectedAction(string selectedItem)
        {
        ...
        class ItemsDataSource : UITableViewSource
        {
            ...
            public ItemsDataSource(List<string> tableData, Action<string> selectedAction)
            {
                this.tableData = tableData;
            ...
            public override UITableViewCell GetCell(UITableView tableView, NSIndexPath indexPath)
            {
                ...
                string item = tableData[indexPath.Row];
